    ...
    subPropertySetFactory({ object, schema, parentProperties = [], }) {
      ...
      return function subPropertySet(property, value) {
        ...
        if (typeof property !== 'symbol') {
          self[MODEL.LIST_UPDATED_FIELDS].push(parentProperties.concat(property).join('.'));
